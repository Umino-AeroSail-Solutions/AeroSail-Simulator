...
# Sail.get_cf()
# print('Got Cf')
# Sail.plot_cts_for_AWA(np.radians(30), 35)
# Sail.plot_cts_for_AWA(np.radians(30), 25)
# Sail.plot_cts_for_AWA(np.radians(60), 35)
# Sail.plot_cts_for_AWA(np.radians(130), 35)
# Sail.plot_cts_for_AWA(np.radians(150), 35)
# print('Finished')
